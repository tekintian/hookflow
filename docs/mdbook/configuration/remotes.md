...
You can provide multiple remote configs if you want to share yours hookflow configurations across many projects. Hookflow will automatically download and merge configurations into your local `hookflow.yml`.
...
1. Local main config (`hookflow.yml`)
1. Remote configs (`remotes`)
1. Local overrides (`hookflow-local.yml`)
