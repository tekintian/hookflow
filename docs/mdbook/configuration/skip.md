...
> TIP
>
> Always skipping is useful when you have a `hookflow-local.yml` config and you don't want to run some commands locally. So you just overwrite the `skip` option for them to be `true`.
>
> ```yml
> # hookflow.yml
>
