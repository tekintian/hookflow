...
You can configure which glob matching engine hookflow uses to filter files. By default, hookflow uses `gobwas/glob`, but you can opt-in to use `doublestar` for standard glob behavior.
