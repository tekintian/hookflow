...
You can also *extend* this list with an environment variable `HOOKFLOW_OUTPUT`:

```bash
HOOKFLOW_OUTPUT="meta,success,summary" hookflow run pre-commit
```
