...
// Add creates a hook, given in args. The hook is a Hookflow hook.
func (l *Hookflow) Add(_ctx context.Context, args AddArgs) error {
...
func (l *Hookflow) getSourceDirs() (global, local string) {
