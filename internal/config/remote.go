...
type Remote struct {
	GitURL string `json:"git_url,omitempty" jsonschema:"description=A URL to Git repository. It will be accessed with privileges of the machine hookflow runs on." koanf:"git_url" mapstructure:"git_url" toml:"git_url" yaml:"git_url"`
	...
	Configs []string `json:"configs,omitempty" jsonschema:"description=An optional array of config paths from remote's root,default=hookflow.yml" mapstructure:"configs,omitempty" toml:"configs,omitempty" yaml:",omitempty"`
