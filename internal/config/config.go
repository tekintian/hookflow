...
type Config struct {
	MinVersion string `json:"min_version,omitempty" jsonschema:"description=Specify a minimum version for the hookflow binary" koanf:"min_version" mapstructure:"min_version,omitempty"`

	Hookflow string `json:"hookflow,omitempty" jsonschema:"description=Hookflow executable path or command" mapstructure:"hookflow,omitempty"`

	SourceDir string `json:"source_dir,omitempty" jsonschema:"default=.hookflow/,description=Change a directory for script files. Directory for script files contains folders with git hook names which contain script files." koanf:"source_dir" mapstructure:"source_dir,omitempty"`

	SourceDirLocal string `json:"source_dir_local,omitempty" jsonschema:"default=.hookflow-local/,description=Change a directory for local script files (not stored in VCS)" koanf:"source_dir_local" mapstructure:"source_dir_local,omitempty"`
	...
	Colors any `json:"colors,omitempty" jsonschema:"description=Enable disable or set your own colors for hookflow output,default=true,oneof_type=boolean;object" mapstructure:"colors,omitempty"`
	...
	AssertHookflowInstalled bool `json:"assert_hookflow_installed,omitempty" koanf:"assert_hookflow_installed" mapstructure:"assert_hookflow_installed,omitempty"`
	...
	NoAutoInstall bool `json:"no_auto_install,omitempty" jsonschema:"description=Do not automatically install hooks when running hookflow" koanf:"no_auto_install" mapstructure:"no_auto_install,omitempty"`
	...
	Remotes []*Remote `json:"remotes,omitempty" jsonschema:"description=Provide multiple remote configs to use hookflow configurations shared across projects. Hookflow will automatically download and merge configurations into main config." mapstructure:"remotes,omitempty"`
