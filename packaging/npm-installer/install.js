...
async function install() {
  ...
  const fileName = `hookflow${extension}`
...
function getDownloadURL() {
  ...
  return `https://github.com/tekintian/hookflow/releases/download/v${version}/hookflow_${version}_${downloadOS}_${arch}${extension}`
}
